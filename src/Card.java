...
public class Card {
     ...
     * integer.
     *
     * @param cardId the unique integer identification number for the desired
     * card
    ...
    /**
     * Return unique integer card identification number according to
     * "suit-major" ordering where cards are ordered A, 2, ..., K within suits
     * that are ordered alphabetically. This identification number is the
     * 0-based suit integer times the number of ranks plus the 0-based rank
     * number.
     *
     * @return the 0-based suit integer times the number of ranks plus the
     * 0-based rank number
     */
