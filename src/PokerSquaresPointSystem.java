...
public class PokerSquaresPointSystem {
     ...
     *
     * @return a random point system with scores uniformly distributed across
     * the range of all allowable values
     */
    ...
    /**
     * Return a random hypercorner point system where hand scores are either -1
     ...
     * classification identification number) scores 1 point. All other hands
     * score nothing.
     *
     * @param pokerHandId Poker hand classification identification number
     * @return a point system where only the one Poker hand (given by Poker hand
    ...
    /**
     * Return a point system where only one randomly selected Poker hand scores
     * 1 point. All other hands score nothing.
     *
     * @return a point system where only one randomly selected Poker hand scores
     * 1 point
     */
    ...
    /**
     * Return an "Ameritish" point system randomly generated between the
     * normalized point ranges established by the American and British systems.
     *
     * @return an "Ameritish" point system randomly generated between the
     * normalized point ranges established by the American and British systems
     */
